    ...
    <div className="min-h-screen bg-gradient-to-b from-green-50 to-white py-8">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-3xl font-bold text-center text-green-800 mb-2">Contact Us</h1>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <h2 className="text-2xl font-bold text-center text-green-800 mb-8">Connect With Us</h2>
            ...
            <div className="flex flex-col items-center">
              <div className="flex flex-wrap justify-center gap-6 mb-8">
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full text-white shadow-lg hover:scale-110 transition-transform"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M24 5.457v13.909c0 .904-.732 1.636-1.636 1.636h-3.819V11.73L12 16.64l-6.545-4.91v9.273H1.636A1.636 1.636 0 0 1 0 19.366V5.457c0-.904.732-1.636 1.636-1.636h.182l10.4 7.8a1.634 1.634 0 0 0 1.964 0l10.4-7.8h.182c.904 0 1.636.732 1.636 1.636z"/>
                  </svg>
                </a>
              </div>
              
              <p className="text-gray-600 text-center max-w-md">
                Connect with us on social media for updates, tips, and exclusive offers on our herbal hair care products.
              </p>
            </div>
          </div>
          
          <div className="bg-gradient-to-r from-green-700 to-emerald-800 rounded-2xl p-8 text-white text-center">
