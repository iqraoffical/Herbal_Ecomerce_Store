...
export default function OrderPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Generate WhatsApp message with the required format
        ...
        setSuccessMessage('Order placed successfully! Check your WhatsApp for order confirmation.');
        ...
        <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-6 md:p-8">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <label htmlFor="quantity" className="block text-green-800 font-medium mb-2">Quantity</label>
                <select
                  id="quantity"
                  name="quantity"
            ...
            <div className="bg-green-50 p-4 rounded-lg mb-6">
              ...
              <div className="flex justify-between">
                <span>Herbal Hair Oil (100ml)</span>
                <span>₹499 × {formData.quantity} = ₹{formData.quantity * 499}</span>
              </div>
              <div className="flex justify-between mt-2 font-bold">
                <span>Total:</span>
                <span>₹{formData.quantity * 499}</span>
              </div>
            </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            ...
            <div className="flex items-center text-sm text-gray-600 mt-2">
              ...
              Pay via UPI, Net Banking, or Cards
            </div>
          </div>
        </div>
      </div>
